from constants import c_default_screen_height, c_default_screen_width, StrConstants, c_file_name, c_previous_sum, c_plus
from interface import client_interface
from interface_commands import add_new_entry, generate_xlsx
...
def create_interface():
    ...
    client_interface.\
        ...
        add_button(text=c_plus, command=add_new_entry, row=0, column=8).\
        add_button(text=c.generate_xlsx(), command=generate_xlsx, row=0, column=9).\
